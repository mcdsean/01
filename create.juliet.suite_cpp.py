...
'''
def disable_c_refs_in_main_cpp(main_cpp):
    begin_c_good = '/* BEGIN-AUTOGENERATED-C-GOOD-FUNCTION-CALLS */'
    # replace(tc_file_path, begin_c_good, begin_c_good + '/*')
    begin_c_bad = '/* BEGIN-AUTOGENERATED-C-BAD-FUNCTION-CALLS */'
    # replace(tc_file_path, begin_c_bad, begin_c_bad + '/*')
    # print('FILE_PATH:', tc_file_path)
    ...
    with fileinput.FileInput(main_cpp, inplace=True) as file:
        for line in file:
            # print(line.replace("#ifdef __cplusplus", "#if 0"), end='')
            print(line.replace(begin_c_bad, begin_c_bad + '/*'))
            print(line.replace(begin_c_good, begin_c_good + '/*'))
'''
...
def disable_c_refs_in_main_cpp(main):
    begin_c_good = '/* BEGIN-AUTOGENERATED-C-GOOD-FUNCTION-CALLS */'
    ...
    for path, dirs, files in os.walk(juliet_suite_path_t):
        ...
        if not dirs:
            ...
            if os.path.exists(main_cpp):
                ...
                if language == 'cpp':
                    disable_c_refs_in_main_cpp(main_cpp)
                    if os.path.exists(main_linux_cpp):
                        disable_c_refs_in_main_cpp(main_linux_cpp)
...
if __name__ == '__main__':
    ...
    test_case_complete_path = os.path.join(os.getcwd(), 'juliet_cpp_protection_profile_full_set')
    ...
    # todo: need to wait until deleted, delete manually for now
    '''
